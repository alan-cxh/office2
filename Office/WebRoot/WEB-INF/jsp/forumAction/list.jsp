		...
		<div class="ForumPageTableBorder" style="margin-top: 25px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					...
					<td width="120" class="ForumPageTableTitle">主题数</td>
					<td width="120" class="ForumPageTableTitle">回复数</td>
					<td width="150" class="ForumPageTableTitle">文章数（主题+回复）</td>
					
					<!-- <td width="300" class="ForumPageTableTitle">最后发表的主题</td> -->
				</tr>
				...
				<s:iterator value="#forumList">
					<tr height="78" align="center" class="template">
						...
						<td class="ForumPageTableDataLine"><b>${articleCount-topicCount}</b></td>
						<td class="ForumPageTableDataLine"><b>${articleCount}</b></td>
						<%-- <td class="ForumPageTableDataLine" align="center">
							<ul class="ForumPageTopicUl">
								<li><font color="#444444">　　　　　┌ 主题：</font> 
									<s:a class="ForumTitle" action="topic_show?id=%{lastTopic.id}"><font color="#A33639">${lastTopic.title}</font></s:a>
								</li>
