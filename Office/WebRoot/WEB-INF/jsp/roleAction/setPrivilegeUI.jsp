						...
						<tr class="TableDetail1">
							...
							<td>
								...
								<%-- <s:iterator value="#privilegeList">
									<input name="privilegeIds" type="checkbox" value="${id}" id="cb_${id}" 
								...
								<s:iterator value="#application.topPrivilegeList">
									<li>
									<input name="privilegeIds" type="checkbox" value="${id}" id="cb_${id}" <s:property value="%{id in privilegeIds ? 'checked' : ''}"/>/>
...
<div class="Description">
	...
	1、选中一个权限时：<br/><br/>
	&nbsp;&nbsp;&nbsp;&nbsp; a应该选中他的所有直系上级。<br/><br/>
	&nbsp;&nbsp;&nbsp;&nbsp; b、应该选中他的所有直系下级。<br/><br/>
	
	2、取消选择一个权限时：<br/><br/>
	&nbsp;&nbsp;&nbsp;&nbsp; a、应该取消选择他的所有直系下级。<br/><br/>
	&nbsp;&nbsp;&nbsp;&nbsp; b、如果同级的权限都是未选择状态、就应该取消选中他的直接上级、并向上做这个操作。<br/><br/>
