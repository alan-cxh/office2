        ...
        <tbody id="TableData" class="dataContainer">
        	<s:iterator value="#forumList" status="status">
				<tr class="TableDetail1 template">
					...
					<td align="center">
						<s:a action="forumManage_delete?id=%{id}" onClick="return confirm('您确定要删除此条记录吗?')">删除</s:a>&nbsp;
						<s:a action="forumManage_updateUI?id=%{id}">修改</s:a>&nbsp;
