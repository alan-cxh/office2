...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="department_%{id == null ? 'add' : 'update'}" onsubmit="return isValid_saveDepartmentUI(this);">
    <s:hidden name="id"></s:hidden>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                    	<td>部门名称</td>
                        <td><s:textfield type="text" name="name" cssClass="InputStyle" id="name"></s:textfield>&nbsp;&nbsp;<font color="#A33639">*部门名称不能为空*</font></td>
                    </tr>
        ...
        <div id="InputDetailBar">
            <input type="image" src="${pageContext.request.contextPath}/style/images/save.png" onclick="isEmpty()"/>
