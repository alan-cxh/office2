...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 公共通讯录详细信息
        </div>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td width="100px">移动电话</td>
                     ...
                     <tr><td width="100px" disabled="true">QQ</td>
                        <td><s:textfield name="QQ" cssClass="InputStyle" disabled="true"/></td>
                    <tr><td width="100px" disabled="true">E-mail</td>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					...
					<tr><td width="100px">爱好</td>
                        <td><s:textfield name="hobby" cssClass="InputStyle" disabled="true"/></td>
                    </tr>
