...
<head>
    ...
    <script type="text/javascript">
    	function showDetail(tId) {
			tId = encodeURI(tId);
			var url = "personalAddrBook_detailInfoUI.action?id=" + tId + "&t=" + new Date();
...
<div id="Title_bar">
    <div id="Title_bar_Head"> 
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 个人通讯录管理
        </div>
...
<!--按指定条件查询-->
	<s:form action="personalAddrBook_list" method="post" id="pageForm">
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <s:iterator value="recordList">
            <tr class="TableDetail1 template">
                ...
                <td align="center">&nbsp;
	                <s:a action="personalAddrBook_delete?id=%{id}" onClick="return delConfirm()">删除</s:a>&nbsp;
	                <s:a action="personalAddrBook_updateUI?id=%{id}">修改</s:a>&nbsp;
               	  <%--   <a href="javascript: showDetail('${id}')">查看详细资料</a> --%>
               	    <s:a action="personalAddrBook_detailInfoUI?id=%{id}">查看详细信息</s:a>&nbsp;
                </td>
            </tr>
        </s:iterator>
        </tbody>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            <s:a action="personalAddrBook_addUI"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></s:a>
        </div>
    </div>
</div>
