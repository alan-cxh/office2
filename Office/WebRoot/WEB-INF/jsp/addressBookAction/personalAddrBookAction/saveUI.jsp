...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 个人通讯录设置
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="personalAddrBook_%{id == null ? 'add' : 'update'}" id="form">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100px">姓名</td>
                        <td><s:textfield name="name" id="name" cssClass="InputStyle required"/><font color="red"> *</font></td>
                    </tr>
