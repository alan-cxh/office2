        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
					<td><a href="application_showOnline.action?id=${applicationId}" style="text-decoration: underline">[在线浏览申请的文档]</a></td>
				</tr>
				<tr>
					<td><a href="application_download.action?id=${applicationId}" style="text-decoration: underline">[点击下载申请的文档]</a></td>
				</tr>
                </table>
            </div>
        </div>
