...
<div id="Title_bar" style="margin-bottom: 20px;">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 申请模板列表
        </div>
        <div id="Title_End"></div>
    </div>
</div>

<table width="90%" cellspacing="0" cellpadding="1" border="0" class="TableBorder" style="margin-left: 15px;" align="center">
	<tbody>
		<tr>
			<td>
